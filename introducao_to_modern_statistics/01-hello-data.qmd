...
2.  Existe uma relação entre a o limite de crédito liberado e a taxa de juros?
    ...
    # Conforme gráfico, nao existe relacao entre o limite do empréstimo e a tx de juros. Independente do limite, as tx cobradas, em sua maioria, sao inferiores a 12,75%.
    ```
