...
```{r}
# Amostragem Aleatóri Simples de 150 condados:
...
states_regions <- data.frame(state = state.name, regions = state.region) # consulta chatgpt.
...
Obs.: Foram selecionados 3 representante por estado (50 estados) para que a amostra fosse igual a anterior (150 observacoes).
